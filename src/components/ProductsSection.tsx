  ...
  const productCategories = [
    {
      ...
      icon: Zap,
      specs: ["1000BASE-SX/LX", "550m à 10km", "LC Duplex"],
      image: shopifySfpProducts[0]?.images.edges[0]?.node.url || products[0].image,
    ...
    },
    {
      ...
      icon: Database,
      specs: ["10GBASE-SR/LR", "300m à 10km", "LC Duplex"],
      image: shopifySfpPlusProducts[0]?.images.edges[0]?.node.url || products[1].image,
    ...
    },
    {
      ...
      icon: Network,
      specs: ["40GBASE-SR4/LR4", "150m à 10km", "MPO/MTP"],
      image: shopifyQsfpProducts[0]?.images.edges[0]?.node.url || products[2].image,
    ...
    },
    {
      ...
      icon: Network,
      specs: ["100G/200G/400G", "Jusqu'à 10km", "MPO/MTP"],
      image: shopifyQsfpDdProducts[0]?.images.edges[0]?.node.url || products[3].image,
                ...
                {isEnabled && category.shopifyProducts.length > 0 && (
                  <div className="mb-4 space-y-2">
                    <p className="text-sm font-medium text-primary">
                      {category.shopifyProducts.length} produits disponibles
                    </p>
