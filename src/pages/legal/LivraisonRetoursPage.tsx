...
export default function LivraisonRetoursPage() {
  const deliveryOptions = [
    ...
    },
    {
      ...
      description: "3-5 jours ouvrés en Europe",
      price: "8€ HT"
    },
    {
      icon: MapPin,
      title: "Retrait en point relais",
      description: "Disponible en France",
      price: "5€ HT"
    }
  ];
      ...
      <main className="pt-16 py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center">Options de livraison</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-muted-foreground space-y-1">
                    <li>• Express : 24-48h ouvrées</li>
                    <li>• Standard : 2-3 jours ouvrés</li>
                    <li>• Point relais : 2-4 jours ouvrés</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">🇪🇺 Union Européenne</h4>
                  <ul className="text-muted-foreground space-y-1">
                    <li>• Express : 48-72h ouvrées</li>
                    <li>• Standard : 3-5 jours ouvrés</li>
                    <li>• Autres zones : sur devis</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="bg-primary/5 border border-primary/20 p-6 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">Garantie 12 mois minimum contre les défauts de fabrication</p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Câbles et accessoires</h4>
                    <p className="text-muted-foreground">Garantie 6 mois contre les défauts de fabrication</p>
                  </div>
                </div>
              </div>
