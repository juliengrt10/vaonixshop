export const siteConfig = {
  ...
  // Contact
  contact: {
    email: import.meta.env.VITE_CONTACT_EMAIL || "contact@infractive.com",
    phone: import.meta.env.VITE_CONTACT_PHONE || "+33 1 75 49 81 30 ",
    address: import.meta.env.VITE_COMPANY_ADDRESS || "9/11 rue Jeanne Braconnier, 92360 Meudon, France"
  },
